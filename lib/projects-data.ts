...
export const projects: Project[] = [
  // --- NEW PROJECTS FROM GITHUB (Seen First) ---
  {
    ...
    image: "/career-war-room-ai.png", // Placeholder - make sure to add this image to your public folder
  ...
  },
  {
    ...
    image: "/doctor-on-call-telehealth.png",
  ...
  },
  {
    ...
    image: "/airline-market-trends.png", // Ensure you save your dashboard screenshot with this name in your public folder
  ...
  },
  {
    ...
    image: "/machine-learning-fraud-detection-dashboard.jpg",
  ...
  },
  {
    ...
    image: "/blockchain-crowdfunding-platform-cryptocurrency.jpg",
...

  {
    ...
    image: "/online-learning-platform-education-dashboard.jpg",
  ...
  },
  {
    ...
    image: "/secure-authentication-system-login-dashboard.jpg",
