import { getAssetPath } from './utils'; // adjust path as needed
...
export const projects: Project[] = [
  // --- NEW PROJECTS FROM GITHUB (Seen First) ---
  {
    ...
    image: getAssetPath("career-war-room-ai.png"), // Placeholder - make sure to add this image to your public folder
  ...
  },
  {
    ...
    image: getAssetPath("doctor-on-call-telehealth.png"),
  ...
  },
  {
    ...
    image: getAssetPath("action-detection-ai.png"),
  ...
  },
  {
    ...
    image: getAssetPath("personal-portfolio-v2.png"),
  ...
  },
  {
    ...
    image: getAssetPath("airline-market-trends.png"),// Ensure you save your dashboard screenshot with this name in your public folder
  ...
  // --- EXISTING PROJECTS ---
  {
    ...
    image: getAssetPath("Robotichand.png"),
  ...
  },
  {
    ...
    image: getAssetPath("machine-learning-fraud-detection-dashboard.jpg"),
  ...
  },
  {
    ...
    image: getAssetPath("blockchain-crowdfunding-platform-cryptocurrency.jpg"),
...

  {
    ...
    image: getAssetPath("online-learning-platform-education-dashboard.jpg"),
  ...
  },
  {
    ...
    image: getAssetPath("secure-authentication-system-login-dashboard.jpg"),
